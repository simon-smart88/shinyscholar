---
title: SMART Session `r Sys.Date()`
---
...
Please find below the R code history from your *SMART* v1.0.0 session. 
...
SMART uses the following R packages that must be installed and loaded before starting.
```{r}
library(terra)
library(leaflet)
library(SMART)
