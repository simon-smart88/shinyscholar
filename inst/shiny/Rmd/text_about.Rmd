...
Welcome to *shinyscholar* a template for creating flexible applications to academic standards. The template has very basic core functionality but demonstrates how applications can be created that are modular, reproducible and automatically cite package developers.

The application is written in `R` with the web app development package `{shiny}` and is based on the *Wallace Eco Mod* application (<a href="https://CRAN.R-project.org/package=wallace" target="_blank">CRAN</a>,<a href="https://wallaceecomod.github.io/" target="_blank">website</a>) developed for modelling species distributions (Kass et. al 2018; Kass et al. 2022).
