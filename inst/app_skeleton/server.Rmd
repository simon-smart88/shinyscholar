...
function(input, output, session) {
 ########################## #
  ...
  steps <- data.frame(c(NA, "Welcome to {{app_library}}! This tour will show you various features of the application to help get you started", NA, NA),
                      ...
                      c("a[data-value=\"{{first_component}}\"]", "Click on the tabs to move between components", "bottom", "$('a[data-value=\"How To Use\"]').removeClass('active');
                                                                                                          $('a[data-value=\"{{first_component}}\"]').trigger('click');
                                                                                                          $('a[data-value=\"{{first_component}}\"]').addClass('active');"),
                      c("#{{first_component}}Help", "Click on the question mark to view instructions for the component", "bottom", "$('a[data-value=\"{{first_component}}\"]').removeClass('active');
                                                                                                                     $('a[data-value=\"Component Guidance\"]').trigger('click');
                                                                                                                     $('a[data-value=\"Component Guidance\"]').addClass('active');"),
                      c("#{{first_component}}Sel", "Select a module to load the options", "bottom", "$('a[data-value=\"Component Guidance\"]').removeClass('active');
                                                                                      $('a[data-value=\"Map\"]').trigger('click');
                                                                                      $('a[data-value=\"Map\"]').addClass('active');
                                                                                      $('input[value=\"{{first_module}}\"]').trigger('click');"),
                      c("#{{first_module}}Help", "Click on the question mark to view instructions for the module", "bottom", "$('a[data-value=\"Map\"]').removeClass('active');
                                                                                                                        $('a[data-value=\"Module Guidance\"]').trigger('click');
                                                                                                                        $('a[data-value=\"Module Guidance\"]').addClass('active');"),
```
```{r, purl = {{all(include_table, include_map)}}} 
...
```
```{r, purl = {{!include_code}}}
                      c("a[data-value=\"rep\"]", "You can download code to reproduce your analysis in the Session Code module", "bottom","$('a[data-value=\"Results\"]').removeClass('active');
                                                                                                                                             $('a[data-value=\"rep\"]').trigger('click');
                                                                                                                                             $('a[data-value=\"rep\"]').addClass('active');
                                                                                                                                             $('input[value=\"rep_markdown\"]').trigger('click');"),
```
```{r}
                      c("a[data-value=\"{{first_component}}\"]", "When you are inside an analysis component...","bottom", "$('a[data-value=\"rep\"]').removeClass('active');
                                                                                                             $('a[data-value=\"{{first_component}}\"]').trigger('click');
                                                                                                             $('a[data-value=\"{{first_component}}\"]').addClass('active');"),
                      ...
                      c("a[data-value=\"intro\"]", "Next time you visit...", "bottom", "$('a[data-value=\"{{first_component}}\"]').removeClass('active');
  ...
  # Help Component
  help_components <- {{added_component_list}}
...
```{r purl = {{include_code}}}
  ...
  ############################################# #
    ...
    if (input$code_choice == "Markdown"){
      code <- readLines(system.file(glue("shiny/modules/{module()}.Rmd"), package = "{{app_library}}"))
    }
    cat(code,sep="\n")
  })
```
```{r}
  ...
  output$dlRMD <- downloadHandler(
    filename = function() {
      paste0("{{app_library}}-session-", Sys.Date(), filetype_to_ext(input$rmdFileType))
    },
    content = function(file) {
      md_files <- c()
  ...
  output$dlrefPackages <- downloadHandler(
    ...
    content = function(file) {
      ...
      knitcitations::citep(citation("{{app_library}}"))
  ...
  output$save_session <- downloadHandler(
    filename = function() {
      paste0("{{app_library}}-session-", Sys.Date(), ".rds")
    },
    content = function(file) {
      save_session(file)
    }
